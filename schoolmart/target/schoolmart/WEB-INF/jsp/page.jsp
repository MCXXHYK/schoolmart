...
<script>
    function Go(url) {
        let uu = $("#uu").val();
        $('#content').load(url + "pageNumber=" + uu);
    }
...
<div style='text-align:center;'>
    ...
    <input type='text' id="uu" class='form-control' style='display:inline;width:60px;' value=''/>
    <a class='btn btn-info' href='javascript:void(0);' onclick='Go("${param.url1}")'>GO</a>
</div>
